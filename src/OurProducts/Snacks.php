...
<body>
	...
	<div style="padding: 15px 0px; font-size: 15px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysqli_query($conn,"SELECT * FROM products WHERE available >='1' AND item ='snack'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										...
										<div style="text-align: center; padding: 0 0 6px 0;"> <span style="font-size: 15px">'.$pName.'</span><br> <span style="font-size: 15px">Price: Rs. '.$price.'</span></div>
									</div>
